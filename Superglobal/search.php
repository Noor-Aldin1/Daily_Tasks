...
<body>
    <div class="searchBox">
        <form action="Search_Result.php" method="GET">
            <input class="searchInput" id="input" type="URL" name="search" placeholder="Search something URL" required>
            <button onclick="alert()" class="searchButton" type="submit">
